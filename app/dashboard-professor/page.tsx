...
export default function DashboardProfessor() {
    ...
    const recentActivities = [
        {
            id: 1,
            message: 'Novo estudante se inscreveu em "React Advanced"',
            time: '1 hora atrás',
        },
        {
            id: 2,
        ...
        {
            id: 3,
            message: 'Aula "Hooks Avançados" foi concluída por 12 alunos',
            time: '5 horas atrás',
        },
        {
            id: 4,
            message: 'Novo comentário no curso "JavaScript Fundamentals"',
            time: '1 dia atrás',
        },
    ];
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600">
                                Bem-vindo, Prof. {displayUser.name}
                            </p>
                        </div>
                    </div>
                </div>
