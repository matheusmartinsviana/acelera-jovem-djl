        ...
        <div className="min-h-screen bg-background">
            ...
            Plataforma #1 em Educação Digital
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
                        Conecte-se com conteúdos premium, participe de fóruns
                        interativos e acelere seu aprendizado com nossa trilha
                        de ensino personalizada. Transforme sua carreira com
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-16 animate-slide-up">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Descubra todas as ferramentas que tornam nossa
                            plataforma única e eficaz para seu aprendizado
                        </p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        <Card className="text-center group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-white/80 dark:bg-gray-900/5 backdrop-blur-sm">
                            <CardHeader className="pb-8">
                                <div className="flex justify-center items-center inset-0 bg-blue-100 dark:bg-blue-900/30 rounded-full w-20 h-20 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                                    <BookOpen className="h-12 w-12 text-blue-600 dark:text-blue-400" />
                                </div>
                                <CardTitle className="text-xl mb-3">
                                    Explore novas oportunidades de aprendizado
                                </CardTitle>
                                <CardDescription className="text-base leading-relaxed">
                                    Acesse materiais exclusivos e conteúdos
                                    freemium de alta qualidade criados por
                        ...
                        <Card className="text-center group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-white/80 dark:bg-gray-900/5 backdrop-blur-sm">
                            <CardHeader className="pb-8">
                                <div className="flex justify-center items-center inset-0 bg-purple-100 dark:bg-purple-900/30 rounded-full w-20 h-20 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                                ...
                                <CardDescription className="text-base leading-relaxed">
                                    Participe de discussões enriquecedoras e
                                    tire dúvidas com outros estudantes e
                        ...
                        <Card className="text-center group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-white/80 dark:bg-gray-900/5 backdrop-blur-sm">
                            <CardHeader className="pb-8">
                                <div className="flex justify-center items-center inset-0 bg-indigo-100 dark:bg-indigo-900/30 rounded-full w-20 h-20 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                                ...
                                <CardDescription className="text-base leading-relaxed">
                                    Conecte-se com instituições parceiras
                                    renomadas e amplie suas oportunidades
                                    profissionais
                                </CardDescription>
                            </CardHeader>
                        </Card>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">
                                            Metodologia comprovada que acelera
                                            seu processo de aprendizado em até
                                            3x
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">
                                            Certificados válidos e reconhecidos
            ...
            <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                        Junte-se a milhares de estudantes que já estão
                        acelerando seu aprendizado e transformando suas
                        carreiras
                    </p>
                    <Link href="/cadastro">
                        <Button
            ...
            <footer className="bg-muted py-12 px-4">
                <div className="container mx-auto">
                    ...
                    <div className="border-t mt-8 pt-8 text-center text-muted-foreground">
                        <p>
                            &copy; 2024 Acelera Jovem. Todos os direitos
                            reservados.
                        </p>
                    </div>
                </div>
